package com.bank.bian.syndicatedloan.model;
...
/**
 * The BIAN control record for this service domain: "Syndicated Loan Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Syndicated Loan Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Syndicated Loan Facility Fulfillment Arrangement";
